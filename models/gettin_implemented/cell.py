...
def alpha_d(V):
    return 0.092 * np.exp(-0.01 * (V - 5)) / (1 + np.exp(-0.072 * (V - 5)))
...
def beta_f(V):
    return 0.0065 * np.exp(-0.002 * (V + 30)) / (1 + np.exp(-0.2 * (V + 30)))
...
def alpha_X(V):
    return 0.0005 * np.exp(0.083 * (V + 50)) / (1 + e **(0.057 * (V + 50)))

def beta_X(V):
    return 0.0013 * np.exp(-0.06 * (V + 20)) / (1 + e **(-0.04 * (V + 20)))
